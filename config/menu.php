...
//        ->url('http://www.google.com', 'Google')
        ...
        #adminlte_menu
        ->add(Link::toUrl('link', '<i class="fa fa-link"></i><span>about</span>'))
        ->add(Link::toUrl('link', '<i class="fa fa-link"></i><span>dashboard</span>'))
...
//                ->urldecode(str)l('http://www.google.com', 'Google')
//        )
